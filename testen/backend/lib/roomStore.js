...
// Persistente Metadaten (Name, Blockliste) – bleiben nach Neustart im RAM
const roomsMeta = new Map();   // hash → { name, blocklist }

// Laufzeit-Strukturen (Clients, History …) – entstehen bei erster WS-Verbindung
const liveRooms = new Map();   // hash → roomRuntime
